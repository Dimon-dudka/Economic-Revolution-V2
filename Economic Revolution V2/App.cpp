...
{
	Image iconApp;
	if (!iconApp.loadFromFile("textures/ICON_TEST.png"))cout << "ERROR::APP::INITTICON::Failed to load icon texture!\n";
...
{
	if (!musicApp.openFromFile("sound/ARMEE.flac")) {  //"Armee der Tristen" is a test soundtrack
...
{
	if (!font.loadFromFile("fonts/Deutsch_Gothic.ttf")) {
